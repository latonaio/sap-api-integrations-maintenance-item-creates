...
import (
	sap_api_caller "sap-api-integrations-maintenance-item-creates/SAP_API_Caller"
	sap_api_input_reader "sap-api-integrations-maintenance-item-creates/SAP_API_Input_Reader"
	"sap-api-integrations-maintenance-item-creates/config"
...
func main() {
	...
	inputSDC := fr.ReadSDC("./Inputs/SDC_Maintenance_Item_sample.json")
	...
	caller.AsyncPostMaintenanceItem(
		item,
		accepter,
	)
}
